...
The 209,824 coordinate values have been replaced by four numbers and a CRS string. The reconstructed grid is not an approximation — it is the original grid, recovered exactly.
...
A previous iteration of this discussion was published here [hypertidy.org: Coordinates broken in NetCDF](https://www.hypertidy.org/posts/2025-09-04_broken-netcdf/). 
