---
title: "Icechunk is coming - versioned cloud-native Zarr, GDAL, and R"
...
for large scientific datasets. This post is about Icechunk from a GDAL perspective and some impact that will have on the R community and its interactions with Zarr. 
...
*Please hang in here for a few sections*, we are diverting down a GDAL and object storage rabbit hole, but it's not long and then we'll get back to Icechunk in the [naming a thing](#naming-a-thing-inside-a-thing) section. 
...
### Naming a thing inside a thing {#sec-naming}
