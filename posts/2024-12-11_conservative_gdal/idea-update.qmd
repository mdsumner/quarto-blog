...
## dsn::mem generates a Memory raster, gdal_raster_data is the warper, here we get identity
...
So we have a lot more values as we resized from 2x2 to 64x64. 
...
newg <- gdal_raster_data(dsn::mem(g1, extent = e1, projection = "EPSG:4326"), 
                         target_ext = prex, target_res = 10000, target_crs = crs, resample = "sum")
plot(tor(newg))
sum(newg[[1]])
