...
There is ongoing work to bring the full GDAL API to R in [{gdalraster}](https://github/USDAForestService/gdalraster), and in in-development version of gdalraster to add the `GDALMultiDimRaster` class and helpers: https://github.com/mdsumner/gdalraster/tree/multidimnew. 
