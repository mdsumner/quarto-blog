...
To actually load this python library we use {reticulate} `py_require()` which drives the awesome [Python uv](https://docs.astral.sh/uv/) package manager. 
